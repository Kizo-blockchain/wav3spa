    ...
    return (
      <div className={ classes.root }>
        {/* <Typography variant="h2" className={ classes.title }>
          <Link href={(i18n.language=== 'zh' || i18n.language === 'zh-CN')? "https://www.yfrb.finance/":"https://www.yfrb.finance/"} target="_blank">{t('RewardPools.Title')}</Link>
        </Typography> */}
        {/* {(i18n.language=== 'zh' || i18n.language === 'zh-CN') &&<Typography variant="h3" className={ classes.subtitle }><Link href="https://www.yfrb.finance/" target="_blank">{t('RewardPools.Subtitle')}</Link></Typography>} */}
