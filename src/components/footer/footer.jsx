      ...
      <AppBar position="static" color="transparent" className={classes.appbar}>
        <Toolbar>
          ...
          <div className={classes.buttons}>
            ...
            <Link href="https://twitter.com/yfrbfinance" target="_blank">Twitter</Link>
            <Link href="https://t.me/yfrb_finance" target="_blank">Telegram</Link>
            <Link href="https://discord.gg/9etTxx4" target="_blank">Discord</Link>
              </div>
      </Toolbar>
      </AppBar>
    </div>
