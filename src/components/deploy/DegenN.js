...
import MatrixCollection from './ScribbleSoundMatrixCollection';
 ...
 const  onDeployFlashLoanSmartContract = async () => {
  ...
  return (
   ...
   {matrixs && matrixs.map((matrix,index )=>{
           ...
           return(<MatrixCollection matrix={matrix} matrixid={matrixsid[index]}/>)
...
//  <Grid container xs={12} md={12} item style={{padding:'10px'}}><SoundMatrixD matrix={matrixs[1]}/></Grid>
// <Grid container xs={12} md={12} item style={{padding:'10px'}}><SoundMatrixD matrix={matrixs[2]}/></Grid>
