...
function ResponsiveDrawer(props) {
 ...
 const  onDeployFlashLoanSmartContract = async () => {
  ...
  <p class="title">Information</p>
    <p style={{color:'white',fontFamily: '"Press Start 2P", cursive'}} class="nes-text is-primary">The Deploy Button here will deploy a Smart contract on Ethereum for the pairs stated. Example of ETH/DAI pair, this Smart Contract will be able to avail loan in DAI from Aave Lending Pool and execute swap between Kyber and Uniswap between ETH-DAI.
             The deployed smart contract will work together with the YFRB Arbitrage bot to execute Flashloan Arbitrage when profit Opportunity is seen.

             The Loan Amount can be configured in the YFRB Arbitrage Bot. Please read instructions for details to run Arbitrage Bot.</p>
</div>
       
<br/><br/>
        <div style={{width:'100%',marginBottom:'20px'}}>
        <button type="button" class="nes-btn is-primary" onClick={onDeployFlashLoanSmartContract}  style={{backgroundColor:'#f507ff',fontFamily: '"Press Start 2P", cursive',marginRight:'10px'}} className={ classes.actionButton }> Deploy Flashloan (ETH/DAI)</button>
        <button type="button" class="nes-btn is-primary" onClick={onDeployFlashLoanSmartContractUSDT} style={{backgroundColor:'#f507ff',fontFamily: '"Press Start 2P", cursive',marginRight:'10px'}} className={ classes.actionButton }> Deploy Flashloan(ETH/USDT)</button>
        <button type="button" class="nes-btn is-primary" onClick={onDeployFlashLoanSmartContractUSDC} style={{backgroundColor:'#f507ff',fontFamily: '"Press Start 2P", cursive',marginRight:'10px'}} className={ classes.actionButton }>Deploy Flashloan(ETH/USDC)</button>
        </div>
