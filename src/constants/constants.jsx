export const DEPLOY_FLASHLOAN = 'DEPLOY_FLASHLOAN'
export const DEPLOY_FLASHLOANUSDT = 'DEPLOY_FLASHLOANUSDT'
export const DEPLOY_FLASHLOANUSDC = 'DEPLOY_FLASHLOANUSDC'

export const DEPLOY_NFT = 'DEPLOY_NFT'

export const BURN_NFT = 'BURN_NFT'

export const DEPLOY_FLASHLOAN_RETURNED = 'DEPLOY_FLASHLOAN_RETURNED'
export const DEPLOY_FLASHLOAN_RECEIPT_RETURNED = 'DEPLOY_FLASHLOAN_RECEIPT_RETURNED'
...
export const DAI_BALANCE = 'DAI_BALANCE'

export const STAKE_YFRB = 'STAKE_YFRB'

export const UNSTAKE_YFRB = 'UNSTAKE_YFRB'

export const APPROVE_YFRB = 'APPROVE_YFRB'
